         ...
         <div className="flex flex-row items-center gap-[2vw]">
            {models.left.map(({ img_url, width, display }) => (
               <Image
                  ...
                  width={175}
                  height={275}
                  className={`  ${display.includes("tablet") ? `block lg:w-[${width.desktop}vw] md:w-[${width.tablet}vw]` : `hidden lg:block `}`}
               />
            ))}
         </div>
         <div className="flex flex-col gap-[1.5vw] items-center">
            <h1 className="md:text-[4.5vw] lg:text-[2.75vw] font-bold text-forest-green">
               Get 69% Off
            </h1>
            ...
            <div>
               <button className="md:text-[2vw] lg:text-[1vw] flex flex-row items-center gap-[2vw] bg-gradient-to-b from-slight-forest-green to-forest-green rounded-full md:px-[3.5vw]  lg:px-[2vw] md:py-[1.5vw] lg:py-[1vw] text-mint-green font-medium">
